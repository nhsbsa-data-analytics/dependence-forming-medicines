...
meta_descs <-
  c(
    "The age band of the patient as of the 30th September of the corresponding financial quarter the drug was prescribed.",
...
write_sheet(
  ...
  "Patient_Identification",
  paste0(
    "Dependency-Forming Medicines - Q1 2015/16 to ",
    config$quarter,
    " - Proportion of items for which an NHS number was recorded (%) by drug category and financial quarter"
  ),
  c(
...
write_sheet(
  ...
  "National",
  paste0(
    "Dependency-Forming Medicines - England Q1 2015/16 to ",
    config$quarter,
    " - Financial quarter totals"
  ),
  c(
...
write_sheet(
  ...
  paste0(
    "Dependency-Forming Medicines - England Q1 2015/16 to ",
    config$quarter,
    " - Financial quarter totals by drug category"
  ),
  c(
    "1. Field definitions can be found on the 'Metadata' tab.",
    "2. Statistical disclosure control has been applied to cells containing fewer than 5 patients or items. These cells will appear blank.",
  ...
  category_data_quarterly |> select(-`BNF Section Name`, -`BNF Section Code`),
  14
)
...
write_sheet(
  ...
  paste0(
    "Dependency-Forming Medicines - England Q1 2015/16 to ",
    config$quarter,
    " - Financial quarter totals by BNF paragraph"
  ),
  c(
    "1. Field definitions can be found on the 'Metadata' tab.",
    "2. Statistical disclosure control has been applied to cells containing fewer than 5 patients or items. These cells will appear blank.",
...
write_sheet(
  ...
  paste0(
    "Dependency-Forming Medicines - England Q1 2015/16 to ",
    config$quarter,
    " - Financial quarter totals by BNF chemical substance"
  ),
  c(
    "1. Field definitions can be found on the 'Metadata' tab.",
    "2. Statistical disclosure control has been applied to cells containing fewer than 5 patients or items. These cells will appear blank.",
...
write_sheet(
  ...
  paste0(
    "Dependency-Forming Medicines - England Q1 2015/16 to ",
    config$quarter,
    " - Financial quarter totals by Integrated Care Board"
  ),
  c(
    "1. Field definitions can be found on the 'Metadata' tab.",
    "2. Statistical disclosure control has been applied to cells containing fewer than 5 patients or items. These cells will appear blank.",
...
write_sheet(
  ...
  paste0(
    "Dependency-Forming Medicines - England Q1 2015/16 to ",
    config$quarter,
    " - Financial quarter totals by Integrated Care Board and drug category"
  ),
  c(
    "1. Field definitions can be found on the 'Metadata' tab.",
    "2. Statistical disclosure control has been applied to cells containing fewer than 5 patients or items. These cells will appear blank.",
...
write_sheet(
  ...
  paste0(
    "Dependency-Forming Medicines - England Q1 2015/16 to ",
    config$quarter,
    " - Financial quarter totals by gender"
  ),
  c(
    "1. Field definitions can be found on the 'Metadata' tab.",
    "2. Statistical disclosure control has been applied to cells containing fewer than 5 patients or items. These cells will appear blank.",
...
write_sheet(
  ...
  paste0(
    "Dependency-Forming Medicines - England Q1 2015/16 to ",
    config$quarter,
    " - Financial quarter totals by drug category and gender"
  ),
  c(
    "1. Field definitions can be found on the 'Metadata' tab.",
    "2. Statistical disclosure control has been applied to cells containing fewer than 5 patients or items. These cells will appear blank.",
...
write_sheet(
  ...
  paste0(
    "Dependency-Forming Medicines - England Q1 2015/16 to ",
    config$quarter,
    " - Financial quarter totals by age band"
  ),
  c(
    "1. Field definitions can be found on the 'Metadata' tab.",
    "2. Statistical disclosure control has been applied to cells containing fewer than 5 patients or items. These cells will appear blank.",
...
write_sheet(
  ...
  paste0(
    "Dependency-Forming Medicines - England Q1 2015/16 to ",
    config$quarter,
    " - Financial quarter totals by drug category and age band"
  ),
  c(
    "1. Field definitions can be found on the 'Metadata' tab.",
    "2. Statistical disclosure control has been applied to cells containing fewer than 5 patients or items. These cells will appear blank.",
...
write_sheet(
  ...
  paste0(
    "Dependency-Forming Medicines - England Q1 2015/16 to ",
    config$quarter,
    " - Financial quarter totals by age band and gender"
  ),
  c(
    "1. Field definitions can be found on the 'Metadata' tab.",
    "2. Statistical disclosure control has been applied to cells containing fewer than 5 patients or items. These cells will appear blank.",
...
write_sheet(
  ...
  paste0(
    "Dependency-Forming Medicines - England Q1 2015/16 to ",
    config$quarter,
    " - Financial quarter totals by age, gender and drug category"
  ),
  c(
    "1. Field definitions can be found on the 'Metadata' tab.",
    "2. Statistical disclosure control has been applied to cells containing fewer than 5 patients or items. These cells will appear blank.",
...
write_sheet(
  ...
  paste0(
    "Dependency-Forming Medicines - England Q1 2015/16 to ",
    config$quarter,
    " - Financial quarter totals by IMD quintile"
  ),
  c(
    "1. Field definitions can be found on the 'Metadata' tab.",
    "2. Statistical disclosure control has been applied to cells containing fewer than 5 patients or items. These cells will appear blank.",
...
write_sheet(
  ...
  paste0(
    "Dependency-Forming Medicines - England Q1 2015/16 to ",
    config$quarter,
    " - Financial quarter totals by drug category and IMD quintile"
  ),
  c(
    "1. Field definitions can be found on the 'Metadata' tab.",
    "2. Statistical disclosure control has been applied to cells containing fewer than 5 patients or items. These cells will appear blank.",
...
write_sheet(
  ...
  paste0(
    ...
    config$month,
    " - Monthly totals by drug category"
  ),
  c(
    "1. Field definitions can be found on the 'Metadata' tab.",
    "2. Statistical disclosure control has been applied to cells containing fewer than 5 patients or items. These cells will appear blank.",
  ...
  category_data_monthly |> select(-`BNF Section Name`, -`BNF Section Code`),
  14
)
...
accessibleTables::makeCoverSheet(
  paste0("Dependency-Forming Medicines - England Q1 2015/16 - ", config$quarter),
  "Financial Quarter Summary Statistics",
...
openxlsx::saveWorkbook(wb,
                       "outputs/dfm_june_2024_costs_and_items_v001.xlsx",
                       overwrite = TRUE)
