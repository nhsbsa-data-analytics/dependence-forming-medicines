---
title: "Dependency Forming Medicines"
...
Date  <- c("June<br> 2015","September 2019","August 2021","April<br>2022","May<br>  2022")
...
#### **`r paste0("Table 1: The proportion of items for which an NHS number was recorded for listed Drug Categories 2018/19 to 2022/23")`**
...
Source: [Dependency forming medicines summary tables - Costs and items (Patient identification rates)](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/dfm/dfm_2021_2022_costs_and_items_v001.xlsx)
...
Source: [Dependency forming medicines summary tables - Costs and items (Table 1)](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/dfm/dfm_2021_2022_costs_and_items_v001.xlsx)
...
Source: [Dependency forming medicines summary tables - Costs and items (Table 2)](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/dfm/dfm_2021_2022_costs_and_items_v001.xlsx)
...
#### **`r paste0("Figure ",4,": Number of identified patients per 1000 population by drug category per financial year")`**


```{r pats_per_drug, out.width = "100%"}

# population_category_extract %>% 
#   group_by(`Financial Year`,`Drug Category`) %>%
#   summarise(`Patients per 1000 Population` = round(`Patients per 1000 Population` )
#     ,0) %>%
#    pivot_longer(cols = c(`Patients per 1000 Population`),
#                names_to = "measure",
#                values_to = "value") %>% 
#   group_chart_hc(
#     x = `Financial Year`,
...
#       type = "line",
#     xLab = "Financial year",
#     yLab = "Patients per 1000 Population",
#     title = "",
#     dlOn = F
#   ) %>% 
#   hc_tooltip(enabled = TRUE,
...
```
Source: [Dependency forming medicines summary tables - Costs and items (Table 4)](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/dfm/dfm_2021_2022_costs_and_items_v001.xlsx)
...
The patients per 1000 population are calculated using the [ONS population estimates](https://www.ons.gov.uk/peoplepopulationandcommunity/populationandmigration/populationestimates),  ONS population estimates for 2021/2022 were not available prior to publication so the figures for 2021 are taken from the [Census](https://www.ons.gov.uk/peoplepopulationandcommunity/populationandmigration/populationestimates/bulletins/populationandhouseholdestimatesenglandandwales/census2021) which is based on the population as of 31 March 2021. Future iterations of the statistics will use the mid year estimate where available.
...
#   
#   mutate(ITEMS_PER_PAT = signif(`Total Items`  / `Total Identified Patients`, 3)) %>%
# 
#   basic_chart_hc(
#     x = `Financial Year`,
#     y = ITEMS_PER_PAT,
...
#### **`r paste0("Figure ",7,": Number of identified patients receiving dependency forming medicine prescribing by sex per financial year")`** 
...
Source: [Dependency forming medicines summary tables - Patient demographics (Table 2)](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/dfm/dfm_2021_2022_patient_demographics_v001.xlsx)
...
#### **`r paste0("Figure ",8,": Number of identified patients receiving dependency forming medicine prescribing by age and sex 2021/22")`** 
...
Source: [Dependency forming medicines summary tables - Patient demographics (Table 6)](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/dfm/dfm_2021_2022_patient_demographics_v001.xlsx)
...
#### **`r paste0("Figure ",9,": Number of identified patients receiving dependency forming medicines prescribing by IMD quintile 2021/22")`** 
...
Source: [Dependency forming medicines summary tables - Patient demographics (Table 8)](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/dfm/dfm_2021_2022_patient_demographics_v001.xlsx)
...
#### **`r paste0("Figure ",10,": Number of identified patients receiving more than one category of dependency forming medicines prescribing by number of categories March 2022")`** 
...
#     y = value,
#     type = "column",
#     xLab = "No of Categories",
#     yLab = "Number of identified patients",
#     title = ""
#   )

```
Source: [Dependency forming medicines summary tables - Patient demographics (Table 10)](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/dfm/dfm_2021_2022_patient_demographics_v001.xlsx)
...
#### **`r paste0("Figure ",11,": Number of identified patients receiving prescribing of a combination of two dependency forming medicines in March 2022")`** 
...
# hc_xAxis(
#     categories = list(
#       "Opioids and <br>Antidepressants",
# "Gabapentinoids and <br>Antidepressants",
# "Opioids and <br>Gabapentinoids",
# "Benzodiazepines and <br>Antidepressants",
# "Z-Drugs and <br>Antidepressants",
# "Opioids and <br>Benzodiazepines",
# "Opioids and <br>Z-Drugs",
# "Benzodiazepines and <br>Gabapentinoids",
# "Benzodiazepines and <br>Z-Drugs",
# "Z-Drugs and <br>Gabapentinoids")
# 
#     )


```
Source: [Dependency forming medicines summary tables - Patient demographics (Table 11)](https://nhsbsa-opendata.s3.eu-west-2.amazonaws.com/dfm/dfm_2021_2022_patient_demographics_v001.xlsx)
...
You can find more information about [insomnia](https://www.nhs.uk/conditions/insomnia/) on the NHS website and further information about [hypnotics and anxiolytics](https://bnf.nice.org.uk/treatment-summaries/hypnotics-and-anxiolytics/) at at the NICE website.
...
The patient deprivation measures given in these statistics are based upon the LSOA of the patient as matched to the May 2022 NSPL file. However, higher geographies included in the statistical summary tables of this publication, such as ICB use NHSBSA administrative records, not geographical boundaries, and more closely reflect the operational organisation of practices than other geographical data sources.
...
## 7. Revisions to this publication
