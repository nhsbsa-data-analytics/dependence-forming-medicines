...
::::{.row style="display: flex; padding-bottom: 10px;"} 
:::{.col-md-6} 
`r infoBox_no_border(header = "", text = "<b>In March 2023, 24% of patients who received a prescription for dependency forming medicines were prescribed drugs from more than one category.</b>", width = "100%")` 
::: 
:::{.col-md-6} 
